...
#                  count = 0           the variable needs to be defined before the loop
#                  if math.cos(r) > 0: r should be r-s
#                      count = 1       count should equal count + 1
#                  return count        count should have paraenthesis
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?  underscore means a loop variable that is not used
#
